...
if(isset($_GET['query'])) {
    // Lấy giá trị tìm kiếm từ tham số query trên URL
    $searchTerm = $_GET['query']; 
    $product_set = search($searchTerm);
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="evo-index-block-blogs">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="new_title">
                                                <h3><a href="tin-tuc" title="Kinh nghiệm hay"> Kết quả tìm kiếm phù hợp</a></h3>
                                            </div>
                                        </div>
                                            ...
                                            <div class="evo-block-product slick-frame slick-initialized slick-slider slick-dotted" role="toolbar">
                                                <div aria-live="polite" class="slick-list draggable">
                                                    <div class="slick-track " role="listbox">
                                                        <?php
                                                        if($product_set < 0 ){
                                                            echo "khong co san pham duoc tiem kiem";
                                                        }else{
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="evo-product-block-item slick-slide slick-current slick-active pl-3 m-2" data-slick-index="0" 
                                                            aria-hidden="false" 
                                                            tabindex="-1" role="option" aria-describedby="slick-slide10" style="width: 174px;">
                                                                <div class="product_thumb ">
                                                                    <a class="primary_img " href="<?php echo 'productdetail.php?id='.$product['product_id']; ?>" 
                                                                    title="Mẹt tre hoa thị 2 lớp" tabindex="0">
                                                                        <img class="img-fluid" src="<?php echo '../hinhanh/' . $product['image_url']; ?>">

                                                                    </a>
                                                                </div>
                                                                <div class="product_content">
                                                                    <a class="product_name" href="<?php echo 'productdetail.php?id='.$product['product_id']; ?>" 
                                                                    title="<?php echo $product['product_name']; ?>" tabindex="0"> <?php echo $product['product_name']; ?></a>
