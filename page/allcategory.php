            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="evo-index-block-blogs">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="new_title">
                                <h3><a href="tin-tuc" title="Kinh nghiệm hay"> Tất cả danh mục sản Phẩm   </a></h3>
                            </div>
                        </div>
                    <div class="evo-index-category-contain ">
                        <div class="evo-block-category slick-frame slick-initialized slick-slider slick-dotted" role="toolbar">
                            <div aria-live="polite" class="slick-list draggable">
                                <div class="slick-track "  role="listbox">
                                    ...
                                    <div class="evo-category-block-item slick-slide slick-current slick-active pl-3 m-3" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide10" style="width: 200px;">
                                        <div class="category_thumb ">
                                            <a class="primary_img " href="<?php echo 'productwithcategory.php?id='.$category['category_id']; ?>" title="Mẹt tre hoa thị 2 lớp" tabindex="0">
                                                <img class="img-thumbnaild" src="<?php echo '../cate/' . $category['image_url']; ?>">
                                        ...
                                        <div class="category_content">
                                            <a class="category_name" href="<?php echo 'productwithcategory.php?id='.$category['category_id']; ?>" title="<?php echo $category['category_name']; ?>" tabindex="0"> <?php echo $category['category_name']; ?></a>
